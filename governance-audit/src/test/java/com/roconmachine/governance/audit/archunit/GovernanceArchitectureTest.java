package com.roconmachine.governance.audit.archunit;
...
class GovernanceArchitectureTest {
    ...
    private static final com.tngtech.archunit.core.domain.JavaClasses CLASSES =
            new ClassFileImporter().importPackages("com.roconmachine.governance.audit");

//    @Test
//    void aspectsMustNotBeCalledDirectlyByConsumers_onlyByAopProxy() {
//        ArchRule rule = noClasses()
//                .that().resideOutsideOfPackage("com.roconmachine.governance.audit.aspect..")
//                .should().dependOnClassesThat().resideInAPackage("com.roconmachine.governance.audit.aspect..");
//        rule.check(CLASSES);
//    }
//
//    @Test
...
//                .that().resideInAPackage("com.roconmachine.governance.audit.publisher..")
//                .and().areNotInterfaces()
//                .should().implement(com.roconmachine.governance.audit.publisher.AuditEventPublisher.class);
//        rule.check(CLASSES);
//    }
//
//    @Test
...
//        ArchRule rule = classes()
//                .that().resideInAPackage("com.roconmachine.governance.audit.annotation..")
